...
''',height=300,)
        ...
        try:
            ...
            components.html(
                ...
                <table height="190" border="1" bordercolor="#99ffeb" cellpadding="4" cellspacing="4" width="500">
                <tbody><tr>
                ...
                <td align="right" width="100" bgcolor=" #ccfff5">
                    <span id="ContentPlaceHolder_NargilBaseBody_ContentPlaceHolder_NargilContentBody_Label31" style="font-size:10pt;font-weight: 700">:نام علمی</span>
                </td>
                </tr>
                <tr>
                <td align="right">
                ...
                <td align="right" width="100" bgcolor=" #ccfff5">
                    <span id="ContentPlaceHolder_NargilBaseBody_ContentPlaceHolder_NargilContentBody_Label33" style="font-size:10pt;font-weight: 700">:خانواده</span>
                </td>
                </tr>
                <tr>
                ...
                <td align="right" width="100" bgcolor=" #ccfff5">
                    <span id="ContentPlaceHolder_NargilBaseBody_ContentPlaceHolder_NargilContentBody_Label34" style="font-size:10pt;font-weight: 700">:بومی منطقه</span>
                </td>
                </tr>
                <tr>
                <td align="right" dir="rtl">
                ...
                <td align="right" width="100" bgcolor=" #ccfff5">
                    <span id="ContentPlaceHolder_NargilBaseBody_ContentPlaceHolder_NargilContentBody_Label35" style="font-size:10pt;font-weight: 700">:نام های دیگر</span>
                </td>
                </tr>
                </tbody></table>
                </td>
                <td align="center" valign="middle" bordercolor="#009900" width="200">
                <img id="ContentPlaceHolder_NargilBaseBody_ContentPlaceHolder_NargilContentBody_Image4" title="Lilium ledebourii" src='data:image/png;base64,{data_url}' style="height:190px;width:200px;">
                </td>
                </tr>
               
               
                <tr>
                <td colspan="2" align="right" valign="middle"><table height="40" width="100%" border="0" cellpadding="0" cellspacing="1" bordercolor="#009900">
                <tbody><tr>
